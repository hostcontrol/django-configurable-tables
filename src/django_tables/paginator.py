...
class ExPaginatorMixin(object):
    ...
    def page(self, number, softlimit=False):
        try:
            return super(ExPaginatorMixin, self).page(number)
...
class DiggPaginatorMixin(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(DiggPaginatorMixin, self).__init__(*args, **kwargs)
    ...
    def page(self, number, *args, **kwargs):
        ...
        page = super(DiggPaginatorMixin, self).page(number, *args, **kwargs)
...
class ExPaginator(ExPaginatorMixin, Paginator):
    pass


class DiggPaginator(DiggPaginatorMixin, ExPaginator):
    pass
